...
pub fn get_instructions(program: &str) -> Option<Instructions> {
...
fn ascii_table(instructions: &mut Instructions) -> Option<Instructions> {
    // MAIN FUNCTION
...
fn brush(instructions: &mut Instructions) -> Option<Instructions> {
    // MAIN FUNCTION
...
fn text_writer(instructions: &mut Instructions) -> Option<Instructions> {
    // MAIN FUNCTION
    instructions.add(vec![Rc::new(DEFLABEL::new("main"))]);
    instructions.add_blocks(vec![update_pen_position(0x00F0)]);
...
fn me(instructions: &mut Instructions) -> Option<Instructions> {
    // MAIN FUNCTION
    instructions.add(vec![Rc::new(DEFLABEL::new("main"))]);
